...
sudo pacman -Syu ttf-liberation ttf-opensans xdg-desktop-portal-wlr slurp grim brightnessctl bluez bluez-utils pavucontrol easyeffects polkit-gnome fcitx5-rime fcitx5-gtk swaybg fprintd cliphist wl-clipboard git fisher fish neovim stow fzf ripgrep wofi otf-monaspace otf-font-awesome pamixer pipewire pipewire-pulse wireplumber alacritty playerctl fastfetch
